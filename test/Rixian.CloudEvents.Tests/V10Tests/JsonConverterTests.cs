...
namespace Rixian.CloudEvents.Tests.V10
{
    ...
    public class JsonConverterTests
    {
        ...
        public void TestStringFilesV02(string fileName)
        {
            ...
            CloudEvent newEvnt = JsonConvert.DeserializeObject<CloudEvent>(json2);

            newEvnt.Should().BeOfType<StringCloudEvent>();
        }
        ...
        public void TestNoDataFiles(string fileName)
        {
            ...
            newEvnt.Should().NotBeOfType<JsonCloudEvent>();
            newEvnt.Should().NotBeOfType<BinaryCloudEvent>();
            newEvnt.Should().NotBeOfType<StringCloudEvent>();
        }
        ...
        public void BinaryEvent_ContainsData_Success(string data)
        {
            ...
            newEvnt.Should().BeOfType<BinaryCloudEvent>();
        ...
        public void BinaryEvent_LargeData_Success(string fileName, string dataContentType)
        {
            ...
            BinaryCloudEvent newEvnt = JsonConvert.DeserializeObject<BinaryCloudEvent>(JsonConvert.SerializeObject(evnt));

            newEvnt.Should().NotBeNull();
            newEvnt.Should().BeOfType<BinaryCloudEvent>();
            newEvnt.DataContentType.Should().Be(dataContentType);
